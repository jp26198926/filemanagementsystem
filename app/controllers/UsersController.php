...
class UsersController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		$db->join("roles", "users.user_role_id = roles.role_id", "LEFT");
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("username","password","email","fullname","date_created","photo","user_role_id");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","username","fullname","date_updated","photo");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'username' => 'required',
			...
			$modeldata = $this->modeldata = $this->validate_form($postdata);
			$modeldata['date_updated'] = date_now();
